...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/Venter.css">
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/Viconfont.css">
	<script src="${pageContext.request.contextPath}/js/jquery-3.0.0"></script>
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/js/jquery-3.0.0">
</head>
<body>
	<div class="top">
	    <div class="left"><span class="iconfont icon-location"></span>${toordinaryHome.findUserByName.nowaddress }</div>
		<div class="right">			   	    
			<span><a href="${pageContext.request.contextPath}/ToUpdatePerson.do">${toordinaryHome.findUserByName.uname }</a>志愿者,你好</span><span>|</span><span><a href="${pageContext.request.contextPath}/logout.do">注销</a></span>
		</div>
		<div class="cen">
		<li>首页</li>
		<li class="fir"><a href="${pageContext.request.contextPath}/listActivity.do">志愿活动</a></li>
		<li>新闻动态</li>
		<li><a href="../html/team.html">团队风采</a></li>
	...
	<div class="act">
		...
		<div class="new">
			<div class="title">
				<h4>我的志愿小时：${toordinaryHome.total}小时</h4>
			</div> 
				<ul>
					<li><span class="iconfont icon-huodong"></span><a href="${pageContext.request.contextPath}/PersonUnpart.do">我报名的活动</a><span class="iconfont icon-baoming"></span></li>
					<c:forEach items="${toordinaryHome.selUnpartByuidPreTwoS}" var="itemT">
					<li>序号:${itemT.unpartid} 活动ID:${itemT.actid} 活动状态:${itemT.status}   <a href="javascript:if(confirm('确实要取消报名吗?'))location='${pageContext.request.contextPath}/CancelUnpartBySelf.do?unpartid=${itemT.unpartid}'">取消</a></li>
					</c:forEach>
					<li><span class="iconfont icon-huodong"></span><a href="${pageContext.request.contextPath}/PersonRecord.do">我参加的活动</a><span class="iconfont icon-canjia"></span></li>
					<c:forEach items="${toordinaryHome.findPreFour}" var="item">
					<li>序号:${item.reacordid} 活动ID:${item.actid} 时长:${item.duration}</li>
					</c:forEach>
				</ul>			
		</div>
	</div>
	...
	<div class="team">
		<ul>
		<c:forEach items="${toordinaryHome.preActivity}" var="itemH">
		<li><img src="${pageContext.request.contextPath}/images/team1.jpg"><span>${itemH.aname } ${itemH.introduce }</span></li>
		</c:forEach>
		<!--  
            ...
            <li><a href="${pageContext.request.contextPath}/listActivity.do"><img src="${pageContext.request.contextPath}/images/more.png"></a></li>
        </ul>
	</div>

	<div class="cenphoto"><img src="../images/湛江志愿.gif"></div>
	<div class="vol"><div class="volu">志愿风采</div></div>

	<div class="voluteer">
		<ul>
		<c:forEach items="${toordinaryHome.preActivity}" var="itemH">
		<li><img src="${pageContext.request.contextPath}/images/team10.jpg"><span>${itemH.aname } ${itemH.introduce }</span></li>
		</c:forEach>
		<!-- 
		    <li><img src="${pageContext.request.contextPath}/images/vol1.jpg"><span>雷州爱心协会合力捐赠100吨瓜菜驰援武汉</span></li>
            ...
            <li><a href="${pageContext.request.contextPath}/listActivity.do"><img src="${pageContext.request.contextPath}/images/more.png"></li> 
        </ul>
	</div>
	<div class="footer">
